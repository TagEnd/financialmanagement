<template>
    <div style="height: 100%; width: 100%;  ">
                ...
                <tbody>
                    <tr tr v-for="item,index in tableData.slice(tableDataStart,tableDataEnd)">
                        <td v-bind:data-index="tableDataStart+index">
                            ...
                            <a href="javascript:;" v-bind:data-index="tableDataStart+index" style="margin-right: 15px"
                                @click="EditProjectInformation(tableDataStart+index,tableData)">编辑</a>
                            <a href="javascript:;" v-bind:data-index="tableDataStart+index"
                                @click="RemoveProjectInformation(tableDataStart+index,tableData)">删除</a>
                        </td>
                    </tr>
                    <tr v-for="item in FillData">
                        <td></td>
        ...
        <el-dialog title="修改项目信息" :visible.sync="ChangeFormVisible" width="600px" lock-scroll top=40px>
            <div class="ChangeProject">
                ...
                <input type="text" class="ChangeProjectInputStyle" v-model:value="ChangeProjectInformation.projectName">
                <span class="ChangeProjectItem">项目总金额</span>
                <input type="text" class="ChangeProjectInputStyle" v-model:value="ChangeProjectInformation.totalAmount">
            ...
            <div slot="footer" class="dialog-footer">
                ...
                <el-button style="padding: 5px;" @click="CanacelProjectChange()">取 消</el-button>
        ...
        <el-dialog title="新建项目" :visible.sync="AddFormVisible" width="600px" lock-scroll top=40px>
            <div class="ChangeProject">
                ...
                <span class="ChangeProjectItem">项目名称</span>
                <input type="text" class="ChangeProjectInputStyle" v-model:value="AddProjectInformation.projectName">
                <span class="ChangeProjectItem">项目总金额</span>
                <input type="text" class="ChangeProjectInputStyle" v-model:value="AddProjectInformation.totalAmount">
                <span class="ChangeProjectItem">项目份额</span>
                <input type="text" class="ChangeProjectInputStyle"
            ...
            <div slot="footer" class="dialog-footer">
                <!-- ChangeFormVisible = false -->
                <el-button style="padding: 5px;" @click="CanacelProjectAdd()">取 消</el-button>
                <el-button type="primary" style="padding: 5px;" @click="DetermineProjectAdd()">确 定</el-button>
            </div>
        </el-dialog>
        <el-dialog title="删除项目" :visible.sync="DelFormVisible" width="600px" lock-scroll top=40px>
            <div style="margin-top: 0px; line-height: 20px; height: 20px; font-size: 15px;">确定要删除该项目吗？</div>
            <div class="ChangeProject">
                <span style="padding-left:20px; margin-top: 10px; line-height: 20px; height: 20px; font-size: 15px;">项目编号：{{DelProjectInformation.projectId}}</span>
                <span style="padding-left:20px; margin-top: 10px; line-height: 20px; height: 20px; font-size: 15px;">项目名称：{{DelProjectInformation.projectName}}</span>
            </div>
            <div slot="footer" class="dialog-footer">
                <!-- ChangeFormVisible = false -->
                <el-button style="padding: 5px;" @click="CanacelProjectDel()">取 消</el-button>
                <el-button type="primary" style="padding: 5px;" @click="DetermineProjectDel()">确 定</el-button>
            </div>
        </el-dialog>
    </div>
</template>
    ...
    export default {
        ...
        methods: {
            ...
            async DetermineProjectDel() {
                const { data: result }  = await this.$http.delete('/api/project/deleteProjectShare/'+ this.DelProjectInformation.projectId);
                console.log('删除信息');
                console.log(result);
                if (result.code == 200) {
                    this.GetProjectInformation();
